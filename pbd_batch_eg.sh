...
#PBS -N jn_jar
#PBS -l nodes=1
#PBS -l select=1:ncpus=4:ppn=1:mem=10GB
#PBS -l walltime=01:00:00

#PBS -j oe
#PBS -o /gpfs1/homes/s4430291/chanlab-genomics/jackknifing/example_out/$PBS_JOBNAME.txt
...
time /gpfs1/homes/s4430291/chanlab-genomics/jackknifing/Jackknife.jar /30days/s4430291/Slin_CCMP2456_jar 40
