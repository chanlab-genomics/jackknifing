#!/bin/bash
#-#PBS -l nodes=1:ppn=2,mem=60GB,vmem=60GB,walltime=12:00:00
#PBS -k oe
#PBS -j oe
# NOTE: This Job array line needs to change!
#PBS -J 0-196
#PBS -N D2S_jellyfish
#PBS -l select=1:ncpus=2:mpiprocs=2:mem=60GB:vmem=60GB,walltime=12:00:00
...
filearray=(/30days/s4430291/$INPUT_DIR/*.fna)
