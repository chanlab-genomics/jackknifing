...
jellyfish dump -ct $file.$k.jf_0 | sort -k1,1 | python /home/s4430291/chanlab-genomics/jackknifing/jf_scripts/Kmers_2_NumbericRepresentation.py -o $file.${k}mer.nkc.gz && \
python /home/s4430291/chanlab-genomics/jackknifing/jf_scripts/Composition_of_InputSeqs.py --fasta $file --freq $file.CharFreq && \
touch $file.done
