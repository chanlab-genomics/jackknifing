...
do
    ...
    tar -czfP /scratch/$PROJECT/$USER/Yeast/D2S_archive/Genomes_for_AFphylogeny_red_40_${SAMPLE_INDEX}_D2S.tz.gz /scratch/$PROJECT/$USER/Yeast/Genomes_for_AFphylogeny_red_40_${SAMPLE_INDEX}_D2S
done